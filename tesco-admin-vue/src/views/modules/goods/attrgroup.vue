      ...
      <div class="mod-config">
        <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
          ...
          <el-form-item>
            ...
            <el-button
              v-if="isAuth('goods:attr:group:save')"
              type="primary"
              @click="addOrUpdateHandle()"
            >新增</el-button>
            <el-button
              v-if="isAuth('goods:attr:group:delete')"
              type="danger"
              @click="deleteHandle()"
        ...
        >
          ...
          <el-table-column prop="attrGroupId" header-align="center" align="center" label="属性分组ID"></el-table-column>
          <el-table-column prop="attrGroupName" header-align="center" align="center" label="属性分组名称"></el-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      getDataList() {
        ...
        this.$http({
          url: this.$http.adornUrl(`/goods/attr/group/list/${this.categoryId}`),
          method: "get",
      ...
      deleteHandle(id) {
        ...
        this.$confirm(
          ...
          this.$http({
            url: this.$http.adornUrl("/goods/attr/group/delete"),
            method: "post",
