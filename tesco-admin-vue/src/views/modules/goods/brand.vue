  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button
          v-if="isAuth('goods:brand:save')"
          type="primary"
          @click="addOrUpdateHandle()"
        >新增</el-button>
        <el-button
          v-if="isAuth('goods:brand:delete')"
          type="danger"
          @click="deleteHandle()"
...
export default {
  ...
  methods: {
    addCatelogSelect() {
      ...
      this.$http({
        url: this.$http.adornUrl("/goods/category/brand/relation/save"),
        method: "post",
        data: this.$http.adornData({brandId:this.brandId,categoryId:this.categoryPath[this.categoryPath.length-1]}, false)
      }).then(({ data }) => {
    ...
    deleteCateRelationHandle(id, brandId) {
      this.$http({
        url: this.$http.adornUrl("/goods/category/brand/relation/delete"),
        method: "post",
    ...
    getDataList() {
      ...
      this.$http({
        url: this.$http.adornUrl("/goods/brand/list"),
        method: "get",
        params: this.$http.adornParams({
          page: this.pageIndex,
          limit: this.pageSize,
    ...
    deleteHandle(id) {
      ...
      this.$confirm(
        ...
        this.$http({
          url: this.$http.adornUrl("/goods/brand/delete"),
          method: "post",
